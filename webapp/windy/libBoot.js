window.W = {
	version: "21.4.1",
	assets: "21.4.1.lib.a51c",
	sha: "f788a51c",
	target: "lib",
	build: "2019-10-14, 12:55"
};
...
var printError = function (t) {
	...
	message = function (t) {
		document.querySelector("#windy").insertAdjacentHTML("beforeend",
	...
	if (DEBUG = !1, window.W && window.W.version)
		if (window.L) {
			...
			window.windyInit = function (t, i) {
				...
				r.open("POST", "https://api4.windy.com/api4/auth", !0), r.setRequestHeader("Content-type", "application/json; charset=utf-8"), r.onload =
					function () {
						var a;
						try {
						...
						var s = a.auth,
							...
							w = a.type,
							y = a.exceeded;
						4 !== r.readyState || parseInt(r.status) >= 300 ? printError("Not authorized to Windy API.") : e(o, c) ? (window.W.windyBoot = {
							options: t,
							cb: i,
							auth: s,
							id: l,
							...
							apiUser: p,
							exceeded: y
						}, n(s)) : printError("Windy API used on unauthorized domain.")
			...
			var e = function (t, e) {
				...
				n = function () {
					var e, n;
					e = "lib.css", (n = document.createElement("link")).rel = "stylesheet", n.href = t + "/" + e, document.head.appendChild(n),
						function (e, n) {
							var i = document.createElement("script");
							i.type = "text/javascript", document.head.appendChild(i), i.async = !0, n && (i.onload = n), i.onerror = function () {
								return printError("Failed to load Windy API.")
							}, i.src = t + "/" + e
						}("lib.js", function () {
							var t = window.W.windyBoot.name;
							(!t || t.length < 5) && message("Missing name of your app. Please go to your API key generation page and fill name of your app.")
						})
				}
